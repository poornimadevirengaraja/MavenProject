...
public class Actionsclass {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		 * //Example-1 //move to element - mouse hover
		 ...
		 * act.moveToElement(element1).build().perform(); Thread.sleep(2000);
		 * driver.quit();
		 */
		
		/*
		 * // Example-2 // Right Click WebDriverManager.chromedriver().setup();
		 ...
		 * Actions act = new Actions(driver); // pass the driver to Actions class
		 * 
		 * // right click on the element - contextclick WebElement element2 =
		 * driver.findElement(By.xpath("//span[text()='right click me']"));
		 * act.contextClick(element2).build().perform(); Thread.sleep(2000); // click on
		 * 'Edit' in 'right click me'
		 ...
		 * Thread.sleep(2000);
		 * 
		 * // doubleclick WebElement element3 =
		 * driver.findElement(By.xpath("//button[text()='Double-Click Me To See Alert']"
		 * )); act.doubleClick(element3).build().perform(); Thread.sleep(2000);
		 * 
		 * //alert (ok) button click (yes) //driver.switchTo().alert().accept();
		 * 
		 * // dismiss the alert (No) // driver.switchTo().alert().dismiss();
		...
		// Example-4 //keyboard Actions - key up and keydown
		WebDriver driver = new ChromeDriver();
		...
		act.moveToElement(element5).click().keyDown(element5, Keys.SHIFT).sendKeys(element5, "fita")
				.keyUp(element5, Keys.SHIFT).build().perform();
		Thread.sleep(3000);

		// ctrl+Z
		act.keyDown(element5, Keys.CONTROL).sendKeys(element5, "z").keyUp(element5, Keys.CONTROL).build().perform();
		Thread.sleep(3000);
